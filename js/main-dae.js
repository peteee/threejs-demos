...
//     var texture9 = new THREE.TextureLoader().load( 'img/NIKEnike.png' );
//     } else {
//     //console.log(n + " is odd");
//     var texture9 = new THREE.TextureLoader().load( 'img/NIKEnike(1).png' );
//     }
    
//     var geometry9 = new THREE.PlaneGeometry( 10/planeScaler, 5/planeScaler );
...
//     } );
//     window['plane'+i] = new THREE.Mesh( geometry9, material9 );
//     //plane2.rotation.y = -3;
//     window['plane'+i].translateZ(-70);
//     if(i<=10) {
//         window['plane'+i].translateX(k*7);
//     }
//     if(i>10&&i<=20) {
//         window['plane'+i].translateY(-5);
//         window['plane'+i].translateX(k*7-77);
//     }
//     if(i>20&&i<=30) {
//         window['plane'+i].translateY(-10);
//         window['plane'+i].translateX(k*7-154);
//     }
//     if(i>30&&i<=40) {
//         window['plane'+i].translateY(-15);
//         window['plane'+i].translateX(k*7-231);
//     }
//     if(i>40&&i<=50) {
//         window['plane'+i].translateY(-20);
//         window['plane'+i].translateX(k*7-308);
//     }
...
const loadingManager = new THREE.LoadingManager( function () {
    ...
    window.smoothcube.scale.set(20,20,20);
    window.smoothcube.position.set(0, -20, 0)
    window.smoothcube.position.y = -70;

    // shadows
    window.smoothcube.castShadow = true;
    window.smoothcube.receiveShadow = false;

    //smoothcube.rotateX(90);
    scene.add( window.smoothcube );
...
daeloader.load( './models/training2.dae', function ( collada ) {

    window.smoothcube = collada.scene;
...
function animation( time ) {
    //plane.rotation.y += 5;
    // window.plane0.rotation.x += 5 / time*15;
    // window.plane2.rotation.x -= 5 / time*15;
    // window.plane4.rotation.x += 5 / time*15;
    // window.plane6.rotation.x -= 5 / time*15;
    // window.plane8.rotation.x += 5 / time*15;
    // window.plane10.rotation.x -= 5 / time*15;
    // window.plane12.rotation.x += 5 / time*15;
    // window.plane14.rotation.x -= 5 / time*15;
    // window.plane16.rotation.x += 5 / time*15;
    // window.plane18.rotation.x -= 5 / time*15;
    // window.plane20.rotation.x += 5 / time*15;
    // window.plane22.rotation.x -= 5 / time*15;
    // window.plane24.rotation.x += 5 / time*15;
    // window.plane26.rotation.x -= 5 / time*15;
    // window.plane28.rotation.x += 5 / time*15;
    // window.plane30.rotation.x -= 5 / time*15;
    // window.plane32.rotation.x += 5 / time*15;
    // window.plane34.rotation.x -= 5 / time*15;
    // window.plane36.rotation.x += 5 / time*15;
    // window.plane38.rotation.x -= 5 / time*15;
    // window.plane40.rotation.x += 5 / time*15;
    // window.plane42.rotation.x -= 5 / time*15;
    // window.plane44.rotation.x += 5 / time*15;
    // window.plane46.rotation.x -= 5 / time*15;
    // window.plane48.rotation.x += 5 / time*15;
